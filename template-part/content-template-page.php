 ...
 *
 * @package CIFOR_Annual_Report_2016
 */
 get_header();
?>
    <!-- Begin Wrapper -->
    <div id="wrapper">
        ...
        <div id="main-slider" class="m-section full-cover" style="background-image: url(<?php echo get_template_directory_uri();?>/assets/images/annual-report-2016-cover-1.jpg);">
        ...
        <div class="m-section m-section-dark m-section main-wrapper-boxed theme-boxed">
            ...
            <div class="twa-head-title m-margin-bottom-20">
                ...
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    ...
                    <path id="svg_1" d="m1145.9,28.3c0,0 -74.4,-7.7 -106,-12.6c-32.6,-5.1 -52.3,-5.2 -83.7,-5.2s-151.5,-1.8 -172.1,1.7s-104,11.3 -139.8,11.9c-35.4,0.7 -139.6,-7.4 -139.6,-7.4c-6.2,-0.9 -12.5,-0.9 -18.7,0.2c0,0 -84.5,7 -113.1,7.3c-31.5,0.3 -108.6,-7.1 -125.3,-7.1c-16.9,0 -50.6,8.3 -67.8,9c-24.1,0.9 -95.8,-8.9 -95.8,-8.9c-3.1,-0.5 -6.2,-0.1 -9.3,0c-8,0.2 -15.5,1.1 -23.1,2.6c-2,0.5 -57.2,10 -77.5,10.4l0,47l1171.8,0l0,-48.9l0,0z" class="ml0"/>
                    <path id="svg_2" d="m-26,49c26.7,0 105.6,-12.8 105.6,-12.8c11.5,-2 23.7,-1.1 34.4,2.3c0,0 34,12.9 61.7,10.7c27.8,-2.1 59.7,-3.3 81.2,-5.6c21.4,-2.1 87.1,-10.7 87.1,-10.7c12.5,-2.3 31.6,-2.5 41.8,-0.2c9.5,2.1 72.2,11.7 98.1,11.7s97.9,-7.2 97.9,-7.2c16.8,-2.6 34.3,-2.2 50.9,0.9c0,0 62.5,2 90.1,2c27.5,0 162.2,-9.6 216.2,-6.5c17.7,1 56.1,5.7 69.6,5.7s137.5,0 137.5,0l0,46l-1172.1,0l0,-36.3z" class="ml1"/>
                    <path id="svg_3" d="m1145.7,53.117279c0,0 -126.2,3.6 -157.3,3.6c-31.4,-0.1 -105.7,-11.3 -131.8,-11.3s-137.1,2.5 -181.9,7.8c-17.4,2.1 -68.2,8.7 -68.2,8.7c-18.9,3.2 -39,2.9 -57.7,-0.8c0,0 -44.5,-6.1 -62.4,-8s-146.7,-2 -146.7,-2c-12.9,-0.2 -25.7,0.5 -38.4,2l-105.5,8.6c-15.1,1.7 -30.6,1.6 -45.7,-0.2l-87.7,-6.4c-10.1,-1.2 -20.5,-1.2 -30.6,-0.2l-57.7,6l0,27.3l1171.8,0l0,-35.1l-0.2,0z" class="ml2"/>
                    <path id="svg_4" d="m-25.8,80.25864c3,-0.2 55.7,-4.3 64.6,-4.3c8.9,0.2 72,6.3 96.8,6.3s152.5,-9.7 152.5,-9.7l128.6,-0.2c30.6,0.5 60.2,1.4 90.7,3.6c17.5,1.2 70,2.6 70,2.6l142.7,-8.5c0,0 61.4,-3.5 123.1,-3.5s85.7,13.7 121.3,13.7s47.1,-9.6 78.5,-9.6s102.8,8 102.8,8l0,31.4l-1171.6,0l0,-29.8z" class="ml3"/>
                    <path id="svg_5" d="m1145.9,96.175919c0,0 -27,1.4 -40.8,-0.6s-51.2,-6.1 -78.1,-5.3c-28.4,0.9 -147.5,-4.4 -175.2,-4.4s-139.7,-3.8 -186,-0.4c-11.5,0.8 -85.4,7.6 -98.5,5.7c0,0 -133.3,-10.2 -146.3,-8.2c-7.4,1.1 -61.2,6.3 -106.6,4.4c-35,-1.5 -53.1,6.3 -63.8,6.3c-10.9,0 -49.3,5.1 -101.4,5.1c-26.4,0 -49.5,-2.5 -76.3,-2.5c-46.9,0.5 -87.7,1.5 -98.8,1.7l0,21.6l1171.8,0l0,-23.4z" class="ml4"/>
                    <path id="svg_6" d="m-25.4,106.082721c12.7,-0.7 46.1,-2.1 58.8,-1.7l142.8,5.7c16.9,0.6 33.8,0.2 50.5,-1.5l119.5,-11.2c31.9,-3 64.4,-2.5 96,1.5l26.8,3.4c57.3,7.3 117.3,12.6 176,7.5l140.6,-11.9c56.5,-4.8 112.1,-0.4 168.8,3.8l192,12.9l0,0l0,5.4l-1171.8,0l0,-13.9z" class="ml5"/>
                </svg>
            </div>
            <?php
            $args = array(
